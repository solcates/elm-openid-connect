...
import App.Url as Url exposing (Url)
    ...
    TopAppBar.view lift
        ...
        [ TopAppBar.section
            ...
            [ case url of
                Url.StartPage ->
                    styled Html.img
                        ...
                        , Options.attribute (Html.src "images/logo_48.jpeg")
                        ]
                        []
            ...
            , TopAppBar.title
                ...
                [ styled span [ cs "catalog-top-app-bar__title--small-screen" ] [ text title ]
...
content : String -> List (Html m) -> Html m
content name nodes =
    styled div
